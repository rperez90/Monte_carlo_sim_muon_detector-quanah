{
   ...
   TFile *f1 = new TFile("hist61_45deg_1126_0ftwater.root","READ");
   TFile *f2 = new TFile("hist61_45deg_1126_20ftwater.root","READ");
   ...
   TH2D* plotAway=new TH2D("plotAway","MC (no tank)",12,-15.0,15.0,12,-15.0,15.0);
   TH2D* plotTank=new TH2D("plotTank","MC (Water 20ft)",12,-15.0,15.0,12,-15.0,15.0);
   ...
   for (int ix=1; ix<nx; ix++) {
      for(int iy=1; iy<ny; iy++) {
         ...
         plotA->Fill(x,y,wt);
         plotAway->Fill(x,y,wtA);
         plotTank->Fill(x,y,wtT);
      }
   }

  plotA->GetXaxis()->SetTitle("X (m)");
  plotA->GetYaxis()->SetTitle("Y (m)");
  plotAway->GetXaxis()->SetTitle("X (m)");
  plotAway->GetYaxis()->SetTitle("Y (m)");
  plotAway->SetAxisRange(0.,150.,"Z");
  plotTank->GetXaxis()->SetTitle("X (m)");
  plotTank->GetYaxis()->SetTitle("Y (m)");
  plotTank->SetAxisRange(0.,150.,"Z");
