...
/// Outer tank shell(iron) /////////////////////////////////////////////////////////////////////////////
  ...
  auto Tank1LV
    = new G4LogicalVolume(Tank1Sub, defaultMaterial, "Tank1Sub");
  ...
  auto Tank2LV
    = new G4LogicalVolume(Tank2S,defaultMaterial,"MidTank");
  ...
  auto Tank3LV
    = new G4LogicalVolume(Tank3Sub, defaultMaterial, "Tank3Sub");
...
/////////////// top insidetank(usually filled with AIR(red color)) ////////////
  ...
  auto WatTank1LV
    = new G4LogicalVolume(WatTank1Sub, waterMaterial, "Tank1Sub");
...
/*//////////////////_13ft_water_(comment this section out and uncomment the 20ft water when needed)/////////////////////////////////////////////////////////////////////////
  ...
  auto WatTank31LV
    = new G4LogicalVolume(WatTank31Sub, defaultMaterial, "WatTank31Sub");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  auto tubeWaterLV
    = new G4LogicalVolume(tubeWaterS, defaultMaterial, "tubeWater"); //water inside tube
...
//  WatTank31LV->SetVisAttributes(new G4VisAttributes(TRUE,G4Colour(1.0,0.0,0.0))); //  blue
//  WatTank21LV->SetVisAttributes(new G4VisAttributes(TRUE,G4Colour(0.0,0.0,1.0))); //  blue
